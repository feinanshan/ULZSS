...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,
        ...
        self.bn2 = BatchNorm(planes, activation='none')
...
class DRN(nn.Module):
    ...
    def __init__(self, block, layers, arch='D',
        ...
        if arch == 'C':
            ...
            self.bn1 = BatchNorm(channels[0], activation='leaky_relu')
            self.relu = nn.ReLU(inplace=True)
            ...
            self.layer0 = nn.Sequential(
                nn.Conv2d(3, channels[0], kernel_size=7, stride=1, padding=3,
                          bias=False),
                BatchNorm(channels[0], activation='leaky_relu'),
            )
    ...
    def _make_conv_layers(self, channels, convs, stride=1, dilation=1, BatchNorm=None):
        ...
        for i in range(convs):
            modules.extend([
                ...
                BatchNorm(channels, activation='leaky_relu')])
